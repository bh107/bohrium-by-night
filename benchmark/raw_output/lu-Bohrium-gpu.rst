...
~~~~~~
    stdout::
        ...
        benchmark/Python/lu.py - target: bhc, bohrium: True, size: 1000, elapsed-time: 4.088788
...
~~~~~~
    stdout::
        ...
        [Info] [GPU] Compile type: async.
        [Info] [GPU] Work group sizes: 1D[128], 2D[32, 4], 3D[32, 2, 2]
        benchmark/Python/lu.py - target: bhc, bohrium: True, size: 1000, elapsed-time: 4.113165
...
~~~~~~
    stdout::
        ...
        [Info] [GPU] Compile type: async.
        [Info] [GPU] Work group sizes: 1D[128], 2D[32, 4], 3D[32, 2, 2]
        benchmark/Python/lu.py - target: bhc, bohrium: True, size: 1000, elapsed-time: 4.094625
